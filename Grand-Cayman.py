...
basicurl = "https://cayman.directory/en/search/people/a/Grand-Cayman/sortby/relevance/page/"
...
for i in range(1, 480):
    ...
    for j in range(len(Cayman_Brac_box)):
        ...
        sub_elements = sentense.split("Grand Cayman")
    ...
    df.to_csv('Result_Grand_Cayman.csv', index = False)
